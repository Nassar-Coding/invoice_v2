...
- [x] G3.5 Code-family coverage: every billed code implemented or explicitly unresolved with owner. — spec/g3_code_families.yaml: 6 civil + 13 drilling families from the verified tables; every billed code (60 civil, 39 drilling) in one family; DS-900 deferred (G5); no unresolved line; X2 checks family, value/reason and pricing tables per line.
